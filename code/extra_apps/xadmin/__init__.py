...
def autodiscover():
    """
    Auto-discover INSTALLED_APPS customer_admin.py modules and fail silently when
    not present. This forces an import on them to register any customer_admin bits they
    may want.
    """
    ...
    for app_config in apps.get_app_configs():
        ...
        # Attempt to import the app's customer_admin module.
        try:
            ...
            # doesn't have an customer_admin module, we can ignore the error
