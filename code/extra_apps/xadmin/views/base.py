...
class ModelAdminView(CommAdminView):
    ...
    def get_object(self, object_id):
        """
        Get model object instance by object_id, used for change customer_admin view
        """
        # first get base customer_admin view property queryset, return default model queryset
        model = self.model
        try:
    ...
    def queryset(self):
        ...
        customer_admin site. This is used by changelist_view.
        """
