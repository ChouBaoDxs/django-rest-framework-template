...
class ListAdminView(ModelAdminView):
    ...
    def make_result_list(self):
        ...
        # Get the number of objects, with customer_admin filters applied.
    ...
    def get_ordering_field(self, field_name):
        ...
        proper model field or the name of a method (on the customer_admin or model) or a
    ...
    def get_ordering(self):
        ...
        First we check the get_ordering() method in model customer_admin, then we check
    ...
    def get(self, request, *args, **kwargs):
        """
        The 'change list' customer_admin view for this model.
        """
