...
class CommentsAdmin(object):
    ...
    def _bulk_flag(self, queryset, action, done_message):
        """
        Flag, approve, or remove some comments from an customer_admin action. Actually
...
# Only register the default customer_admin if the model is the built-in comment model
