...
def quote(s):
    """
    Ensure that primary key values do not confuse the customer_admin URLs by escaping
...
def flatten_fieldsets(fieldsets):
    """Returns a list of field names from an customer_admin fieldsets structure."""
    field_names = []
